...
#define  __attribute__((__always_inline__, __nodebug__, __target__("simd128"), __min_vector_width__(128)))

#define __REQUIRE_CONSTANT(e) _Static_assert(__builtin_constant_p(e), "Expected constant")

// v128 wasm_v128_load(void* mem)
 v128_t  wasm_v128_load(const void* __mem) {
...
// wasm_v128_store(void* mem, v128 a)
 void  wasm_v128_store(void* __mem, v128_t __a) {
  // UB-free unaligned access copied from xmmintrin.h
...
// wasm_i8x16_make(...)
 v128_t  wasm_i8x16_make(int8_t c0, int8_t c1, int8_t c2, int8_t c3, int8_t c4, int8_t c5, int8_t c6, int8_t c7, int8_t c8, int8_t c9, int8_t c10, int8_t c11, int8_t c12, int8_t c13, int8_t c14, int8_t c15) {
  return (v128_t)(__i8x16){c0, c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14, c15};
}

// wasm_i16x8_make(...)
 v128_t  wasm_i16x8_make(int16_t c0, int16_t c1, int16_t c2, int16_t c3, int16_t c4, int16_t c5, int16_t c6, int16_t c7) {
...
// wasm_f32x4_make(...)
 v128_t  wasm_f32x4_make(float c0, float c1, float c2, float c3) {
...
// wasm_f64x2_make(...)
 v128_t  wasm_f64x2_make(double c0, double c1) {
...
// v128_t wasm_v128_not(v128 a)
 v128_t  wasm_v128_not(v128_t a) { return ~a; }

// v128_t wasm_v128_and(v128_t a, v128_t b)
 v128_t  wasm_v128_and(v128_t a, v128_t b) { return a & b; }

// v128_t wasm_v128_or(v128_t a, v128_t b)
 v128_t  wasm_v128_or(v128_t a, v128_t b) { return a | b; }

// v128_t wasm_v128_xor(v128_t a, v128_t b)
 v128_t  wasm_v128_xor(v128_t a, v128_t b) { return a ^ b; }

#ifdef __wasm_unimplemented_simd128__

// v128_t wasm_v128_andnot(v128_t a, v128_t b)
 v128_t  wasm_v128_andnot(v128_t a, v128_t b) { return a & ~b; }
...
// v128_t wasm_i8x64_shr(v128_t a, int32_t b)
 v128_t  wasm_i8x16_shr(v128_t a, int32_t b) {
  return (v128_t)((__i8x16)a >> b);
}
...
// v128_t wasm_add_saturate(v128_t a, v128_t b)
 v128_t  wasm_i8x16_add_saturate(v128_t a, v128_t b) {
  return (v128_t)__builtin_wasm_add_saturate_s_i8x16((__i8x16)a, (__i8x16)b);
}

// v128_t wasm_add_saturate(v128_t a, v128_t b)
 v128_t  wasm_u8x16_add_saturate(v128_t a, v128_t b) {
...
// v128_t wasm_sub_saturate(v128_t a, v128_t b)
 v128_t  wasm_i8x16_sub_saturate(v128_t a, v128_t b) {
  return (v128_t)__builtin_wasm_sub_saturate_s_i8x16((__i8x16)a, (__i8x16)b);
}

// v128_t wasm_sub_saturate(v128_t a, v128_t b)
 v128_t  wasm_u8x16_sub_saturate(v128_t a, v128_t b) {
...
// v128_t wasm_add_saturate(v128_t a, v128_t b)
 v128_t  wasm_i16x8_add_saturate(v128_t a, v128_t b) {
  return (v128_t)__builtin_wasm_add_saturate_s_i16x8((__i16x8)a, (__i16x8)b);
}

// v128_t wasm_add_saturate(v128_t a, v128_t b)
 v128_t  wasm_u16x8_add_saturate(v128_t a, v128_t b) {
...
// v128_t wasm_sub_saturate(v128_t a, v128_t b)
 v128_t  wasm_i16x8_sub_saturate(v128_t a, v128_t b) {
  return (v128_t)__builtin_wasm_sub_saturate_s_i16x8((__i16x8)a, (__i16x8)b);
}

// v128_t wasm_sub_saturate(v128_t a, v128_t b)
 v128_t  wasm_u16x8_sub_saturate(v128_t a, v128_t b) {
...
// v128_t wasm_u64x2_shr_u(v128_t a, int32_t b)
 v128_t  wasm_u64x2_shr(v128_t a, int32_t b) {
...
// v128_t wasm_i64x2_trunc_saturate_f32x4(v128_t a)
 v128_t  wasm_i64x2_trunc_saturate_f64x2(v128_t a) {
